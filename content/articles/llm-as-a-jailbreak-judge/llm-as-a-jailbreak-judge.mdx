...
github_project: 'https://github.com/romaingrx/llm-as-a-jailbreak-judge'
datasets:
  - name: 'HarmBench evaluation'
    link: 'https://github.com/romaingrx/llm-as-a-jailbreak-judge/blob/master/data/eval_harmbench.csv'
    provenance: 'github'
...
cover:
  src: '/blog-assets/llm-as-a-jailbreak-judge/cover.png'
  alt: 'LLM as a Judge'
---
...
<Callout variant="info">
  I'm currently working on better visualizations for the blog posts, I'll update
  this section once I have a better way to display the results.
</Callout>
